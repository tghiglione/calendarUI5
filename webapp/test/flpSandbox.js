					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App de novedades y empleados",
									"targetURL": "#novedades-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"novedades-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=novedades",
									"url": sap.ui.require.toUrl("novedades")
								}
							}
						}
					}
